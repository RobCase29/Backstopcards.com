          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600 mb-4">
                As a passionate fantasy football manager and dynasty league enthusiast, I created Backstop Cards to solve the challenges I faced in managing multiple leagues and making informed decisions about player values and trades.
              </p>
              <p className="text-gray-600">
                This platform combines my love for fantasy football with modern web development to create a tool that helps managers like you make better decisions and win championships.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything you need to dominate your dynasty leagues
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Comprehensive analysis of your Sleeper leagues with detailed statistics, standings, and performance insights.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Real-time player values from KeepTradeCut integrated with your roster for informed decision-making.
              </p>
            </div>
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Transform Your Dynasty League?
          </h2>
